...
public class ProductInfoService {
    ...
    public ListData<Product> getList(ProductSearch search) {
        ...
        if(sPrice != null){
            ...
            andBuilder.and(orBuilder.or(product.salePrice.goe(sPrice)).or(product.consumerPrice.goe(sPrice)));
        }

        if (ePrice != null) {
            BooleanBuilder orBuilder = new BooleanBuilder();
            andBuilder.and(orBuilder.or(product.salePrice.loe(ePrice)).or(product.consumerPrice.loe(ePrice)));
        }
